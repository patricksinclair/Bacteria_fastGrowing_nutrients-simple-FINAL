...
public class BioSystem {
    ...
    public static void nutrientsVsAntibioticsContourPlot(){
        ...
        int L = 500;
        double duration = 500.;
        String filename = "simple-fastGrowers_nutrients_vs_antibiotic-contourPlot-FINAL";
        char token =  'c';
    ...
    public static void nutrientsVsExponentialAntibioticsContourPlot(){
        ...
        int L = 500;
        double duration = 500.;
        String filename = "simple-fastGrowers_nutrients_vs_exponential-antibiotic-contourPlot-FINAL";
    ...
    public static void linearGradient_spatialAndGRateDistributions(){
        ...
        String filename = "simple-fastGrowers-linearGradient-spatialDistribution-FINAL";
        String filename_gRate = "simple-fastGrowers-linearGradient-gRateDistribution-FINAL";
        String filename_precise = "simple-fastGrowers-linearGradient-spatialDistribution_precise-FINAL";
        String filename_gRate_precise = "simple-fastGrowers-linearGradient-gRateDistribution_precise-FINAL";
