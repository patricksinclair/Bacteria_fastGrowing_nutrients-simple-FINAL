...
public class BioSystem {
    ...
    public static void nutrientsVsAntibioticsContourPlot(){
        ...
        int L = 500;
        double duration = 500.;
        String filename = "fastGrowers_nutrients_vs_antibiotic-contourPlot-FINAL";
        char token =  'c';
    ...
    public static void nutrientsVsExponentialAntibioticsContourPlot(){
        ...
        int L = 500;
        double duration = 500.;
        String filename = "fastGrowers_nutrients_vs_exponential-antibiotic-contourPlot-FINAL";
    ...
    public static void linearGradient_spatialAndGRateDistributions(){
        ...
        String filename = "fastGrowers-linearGradient-spatialDistribution-FINAL";
        String filename_gRate = "fastGrowers-linearGradient-gRateDistribution-FINAL";
